          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@solidworkstraining.com" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+6512345678" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
                  +65 1234 5678
                </a>
              </li>
            </ul>
